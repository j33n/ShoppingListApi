...
class ModelsTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.shoppinglist = ShoppingList(
            owner_id="1", title="Yellow Bananas", description="johndoe@sl.com")
        self.shoppinglistitem = ShoppingListItem(
            owner_id="1",
            shoppinglist_id="1",
            item_title="Yellow Bananas with green",
            item_description="And maracuja"
        )
    ...
    def test_shoppinglistitem_model(self):
        ...
        self.assertEquals(str(shoppinglistitem),
                          "<item_title Yellow Bananas with green")
